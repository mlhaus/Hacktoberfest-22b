...
class CountingDuplicatesTest {
    ...
    @Test
    public void mohmeedReturnZero() {
        assertEquals(0, CountingDuplicates.duplicateCount("zaid"));
    }
    @Test
    public void mohmeedReturnsOne() {
        assertEquals(1, CountingDuplicates.duplicateCount("ttable"));
    }
